...
def convert_glm4v_model(model_id, output_dir, quantization_config):
    ...
    model = AutoModelForCausalLM.from_pretrained(model_id, trust_remote_code=True, torch_dtype=torch.float32, _attn_implementation="eager")
